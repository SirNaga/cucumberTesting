...
public class Preisquery {
    ...
    public void starte_preis_app() throws MalformedURLException {
    ...
    public void connection_from_wien_hbf_costs_less_than_bucks() {
        String price = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='connection_item_price']"))).getText();
        price = price.replace(" ", "").replace("€", "").replace(",", ".");
        assertTrue(50>Double.valueOf(price));
